      ...
      <div style={{width: '900px', background: '#fff', overflow: 'hidden'}}>
        ...
        {this.props.getsProfile.base_profile.investor_type==2?
          ...
          <div style={{width:'100%',background:'#223976',overflow:'hidden'}}>
            <div style={{width:'20%',height:'60px',float:'left',textAlign:'center',lineHeight:'60px',color:'#ffffff',fontsize:'18px',borderRight:'1px solid #ffffff',fontFamily:'宋体',boxSizing:'borderBox',borderTop:'2px solid #223976'}}>
            ...
            <div style={{width:'20%',height:'60px',float:'left',textAlign:'center',lineHeight:'60px',color:'#ffffff',fontsize:'18px',fontFamily:'宋体',boxSizing:'borderBox',borderTop:'2px solid #223976'}}>
