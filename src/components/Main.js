        ...
        <Form horizontal onSubmit={this.handleSubmit}>
          ...
          >
            {getFieldDecorator('last_name', {
              rules: [{
                required: true, message: '请输入你的姓的汉语拼音!',
              }, {
          ...
          >
            {getFieldDecorator('first_name', {
              rules: [{
                required: true, message: '请输入你的名的汉语拼音!',
              }, {
                validator: this.checkConfirm,
              }],
            })(
          ...
          >
            {getFieldDecorator('country_of_birth', {
              initialValue: ['lucy', 'jack', 'disabled','yiminghe'],
          ...
          >
            {getFieldDecorator('passport_code', {
              rules: [{
                required: true, message: '请输入你的护照号!',
              }, {
                validator: this.checkConfirm,
              }],
            })(
          ...
          <FormItem {...tailFormItemLayout}>
            <Row style={{marginTop:'50px',paddingBottom:'40px'}}>
              <Col span={8} offset={7}>
                <Button style={{width: '120px',height:'50px',borderRadius:'30px',background:'#223976',color:'#fff',fontSize:'18px'}} type="primary" htmlType="submit" size="large">下一步</Button>
               </Col>
            </Row>
          </FormItem>
        </Form>
